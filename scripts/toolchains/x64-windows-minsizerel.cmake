...
if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
  ...
  set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /utf-8 /GR /EHsc ${MP_BUILD_FLAG}${VCPKG_CXX_FLAGS}" CACHE STRING "")
  set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /utf-8 ${MP_BUILD_FLAG}${VCPKG_C_FLAGS}" CACHE STRING "")

  set(CMAKE_RC_FLAGS "-c65001 /DWIN32" CACHE STRING "")

  set(CMAKE_CXX_FLAGS_MINSIZEREL " /MD /O1 /DNDEBUG /DEBUG:NONE ${VCPKG_CXX_FLAGS_RELEASE}" CACHE STRING "")
  set(CMAKE_C_FLAGS_MINSIZEREL " /MD /O1 /DNDEBUG /DEBUG:NONE ${VCPKG_C_FLAGS_RELEASE}" CACHE STRING "")
