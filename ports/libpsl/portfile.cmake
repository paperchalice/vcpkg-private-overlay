...
file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/libexec")
file(RENAME "${CURRENT_PACKAGES_DIR}/bin/psl-make-dafsa" "${CURRENT_PACKAGES_DIR}/libexec/psl-make-dafsa")
file(REMOVE "${CURRENT_PACKAGES_DIR}/debug/bin/psl-make-dafsa")
vcpkg_copy_tools(TOOL_NAMES psl AUTO_CLEAN)
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/libpsl.psm1 DESTINATION ${CURRENT_PACKAGES_DIR}/share/PowerShell/Modules/libpsl)
