...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
  FEATURES
      liblzma   ZSTD_LZMA_SUPPORT
      zlib      ZSTD_ZLIB_SUPPORT
      lz4       ZSTD_LZ4_SUPPORT
)
...
vcpkg_cmake_configure(
  ...
  OPTIONS_RELEASE
    ...
    -DZSTD_PROGRAMS_LINK_SHARED=${LINK_SHARED}
  OPTIONS_DEBUG
...
if(VCPKG_TARGET_IS_WINDOWS AND ZSTD_BUILD_PROGRAMS)
  ...
  foreach(tool zstdcat unzstd)
    execute_process(COMMAND ${CMAKE_COMMAND} -E create_symlink
      zstd${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${tool}${VCPKG_TARGET_EXECUTABLE_SUFFIX}
